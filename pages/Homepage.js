...
import {
  ...
  img4,
  img5,
} from "../public/Assets/Carousel_sec_img/index.js";
import {
  img_1,
  img_2,
  img_3,
  ...
  img_7,
  img_8,
} from "../public/Assets/Carousel_fourth_img/index.js";
import {
  imgg1,
  imgg2,
  imgg3,
  ...
  imgg8,
  imgg9,
} from "../public/Assets/Carousel_fifth_img/index.js";
import {
  image1,
  image2,
  image3,
  image4,
} from "../public/Assets/Carousel_sixth_img/index.js";
...
import {
  ...
  Img4,
  Img5,
} from "../public/Assets/Carousel_third_img/index.js";
...
export default function Homepage() {
  ...
  const cards_third = [
    ...
    {
      title:
        "Trade in your eligible Mac, Apple watch iPad for instant credit.*",
      titleclr: "purple-500",
  ...
  const cards_fifth = [
    {
      ...
      titleclr: "",
      description:
        "Included with your HomePod, AirPods or selected Beats products.⁺",
      desclr: "",
      footerhead: " ",
      footertitle: " ",
      footertext: "Apple",
      ...
      <div className="bg-slate-100">
        ...
        <div className="mx-6 md:mx-16">
          ...
          <div className="ml-4 pt-6">
            <span className="mt-2 md:mt-0 block sm:inline px-4 py-2 mr-2 border border-solid border-gray-500 rounded-2xl hover:text-white hover:bg-gray-800 hover:cursor-pointer">
              Order Status
            </span>
            <span className="mt-2 md:mt-0 block sm:inline px-4 py-2 mr-2 border border-solid border-gray-500 rounded-2xl hover:text-white hover:bg-gray-800 hover:cursor-pointer">
              Shopping Help
