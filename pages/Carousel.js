...
const Carousel = ({ cards }) => {
  return (
    ...
    {cards.map((card, index) => (
      <div key={index} className="inline-block mr-6 w-full md:w-2/5 py-6 h-4/5">
...
const Carousel_second = ({ cards }) => {
  return (
    ...
    {cards.map((card, index) => (
      <div key={index} className="inline-block mr-4 w-full md:w-2/5 py-4 ml-2">
...
const Carousel_third = ({ cards }) => {
  ...
  return (
    <div className="overflow-x-auto whitespace-nowrap ml-8" style={{ '-ms-overflow-style': 'none', 'scrollbar-width': 'none' }}>
    {cards.map((card, index) => (
      <div key={index} className="inline-block mr-4 w-full md:w-2/5 py-6 mb-8 ">
...
const Carousel_fourth = ({ cards }) => {
  ...
  return (
    <div className="overflow-x-auto whitespace-nowrap ml-8" style={{ '-ms-overflow-style': 'none', 'scrollbar-width': 'none' }}>
    {cards.map((card, index) => (
      <div key={index} className="inline-block mr-4 w-full md:w-2/5 py-4 md:ml-2">
    ...
    {cards.map((card, index) => (
      <div key={index} className="inline-block mr-4 w-4/5 py-6 h-4/5">
        <div className={`relative shadow-lg p-4 rounded-2xl  text-center`} >
          ...
          <div className='mx-auto absolute sm:top-32 sm:left-64'>
          <Image src={card.img}/>
          </div>
...
export  {Carousel, Carousel_second, Carousel_third,Carousel_fourth, Carousel_fifth,Carousel_mainpage};
