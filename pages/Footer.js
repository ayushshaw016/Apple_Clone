      ...
      <div className="bg-slate-100 text-gray-500 text-sm pt-16">
        <div className="mx-8 md:mx-32">
          ...
          <p className="py-8">
            ...
            leading banks. Until 26 June 2024, No Cost EMI is available with the
            purchase of an eligible iPhone made using qualifying cards on 3-,
            6-, 9-, 12-, 18- or 24-month tenures from most leadings banks.
            ...
            <span className="underline text-blue-600">Terms Apply</span>
          </p>
          <p className="pb-4">Representative example:</p>
          <p className="pb-3">
            Based off a 6-month tenure. ₹79900.00 total cost includes 15% p.a.
            and No Cost EMI savings of ₹3380.00, paid over 6 months as six
            monthly payments of ₹13317.00.
          </p>

          <p className="pb-3">
            Based off a 24-month tenure. ₹79900.00 total cost includes 15% p.a.
            and No Cost EMI savings of ₹11242.00, paid over 24 months as 24
            monthly payments of ₹3329.00.
          </p>

          <p className="pb-3">A subscription is required for Apple TV+.</p>
          <p className="border-b-2 border-solid border-black ">&ensp;</p>

          <div className="flex flex-col md:flex-row ml-2 md:justify-between">
            <div>
              ...
              <p className="my-2 hover:underline hover:cursor-pointer">
                iPhone
              </p>
          ...
          <p>
            ...
            or <span className="text-blue-600 underline">other retailer</span>{" "}
          ...
          <div className="flex flex-col md:flex-row mt-6 pb-6">
            ...
            <div className="md:ml-12">
              <span className="border-r-2 border-solid border-black px-3 hover:underline">
                Privacy Policy
              </span>
              <span className="border-r-2 border-solid border-black px-3 hover:underline">
                Terms of Use
            ...
            <div>
              <span className="md:ml-64 hover:cursor-pointer hover:underline">
                India
              </span>
            </div>
          </div>
