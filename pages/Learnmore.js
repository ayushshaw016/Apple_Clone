...
export default function Learnmore(){
    ...
    <p className="bg-slate-800 text-white p-3 text-center">
        ...
        <div className="mx-8 md:mx-32 bg-gray-50 my-8 border-2 border-solid border-black rounded-xl md:pt-16">
            ...
            <Link href="/">
<span className="rounded-full underline border font-bold border-solid border-black px-4 py-2 hover:text-white hover:bg-red-400 hover:border-red-500">X</span>
            </Link>
            </div>
             <p className="text-6xl font-bold text-center justify-end">Buy Now. Pay over Time</p>
             <p className="mt-8">Choose to pay for your new iPhone with No Cost EMI up to 24 months on all iPhone models with most leading banks.</p>
             <p className="mt-8">See how much your monthly instalment would be with 24 months No Cost EMI§</p>
             <div className="mt-6">
