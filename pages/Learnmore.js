    ...
    <>
      ...
      <div className="mx-8 md:mx-32 bg-gray-50 my-8 border-2 border-solid border-black rounded-xl md:pt-16">
        <div className=" mx-4 md:mx-16">
          ...
          <p className="text-xl md:text-6xl font-bold text-center justify-end">
          ...
          <div className="text-md">
            ...
            <p className="mt-8">
              See how much your monthly instalment would be with 24 months No
              Cost EMI§
            </p>
            <div className="mt-6">
            ...
            <div className="flex justify-center">
              <div>
                <Image
                  src={student}
                  className="w-1/6 h-auto rounded-full ml-12"
                />
